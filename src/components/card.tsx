...
const games = [
    { name: "Roulette", tag: "Classic Wheel", accent: "from-red-700/60 via-black/20 to-black/70" },
    { name: "Mines", tag: "High Risk", accent: "from-emerald-700/50 via-black/20 to-black/70" },
    { name: "Blackjack", tag: "Table Favorite", accent: "from-amber-700/50 via-black/20 to-black/70" },
    { name: "Slots", tag: "Jackpot Spin", accent: "from-sky-700/45 via-black/20 to-black/70" },
];
        ...
        <div className="grid w-full grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
            {games.map((game) => (
                <div
                    ...
                    className="group relative h-64 overflow-hidden rounded-2xl border border-true-gold/25 shadow-[0_16px_50px_rgba(0,0,0,0.55)] transition-transform duration-300 hover:-translate-y-1 hover:shadow-[0_24px_70px_rgba(0,0,0,0.7)]"
